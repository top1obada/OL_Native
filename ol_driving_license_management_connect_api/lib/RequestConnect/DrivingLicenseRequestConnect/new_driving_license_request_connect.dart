...
class NewDrivingLicenseRequestConnect {
  NewDrivingLicenseRequestConnect._();

  /// إضافة طلب رخصة قيادة جديد
  /// ترجع الـ RequestID إذا نجح أو ترمي استثناء إذا فشل
  static Future<int?> addNewDrivingLicense(
    ClsNewDrivingLicenseRequestDTO dto,
  ) async {
    try {
      final response = await DioClient.dio.post(
        'NewDrivingLicenseRequest',
        data: dto.toJson(),
      );
